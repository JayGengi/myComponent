package com.jaygengi.buildgradle
...
class ComCodeTransform extends Transform {
    ...
    void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        def box = com.jaygengi.buildgradle.ConvertUtils.toCtClasses(transformInvocation.getInputs(), classPool)
    ...
    private boolean isActivator(CtClass ctClass) {
        try {
            for (CtClass ctClassInter : ctClass.getInterfaces()) {
                if ("com.jaygengi.component.componentlib.applicationlike.IApplicationLike".equals(ctClassInter.name)) {
                    return true
                }
            }
        } catch (Exception e) {
